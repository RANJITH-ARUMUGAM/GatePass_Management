...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const userrole = ReactSession.get("userrole");
    ...
    /* ////////////////////////////////////////////////////////////////// */
    axios.get(`${SERVER_PORT}/programnavmas/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    axios.get(`${SERVER_PORT}/programnavtrn/${ReactSession.get("userrole")}`)
      .then(res => {
        console.log(res.data)
        setDataTrn(res.data)
        if (res.data.length === 0) {
    ...
    axios.get(`${SERVER_PORT}/programnavvws/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    axios.get(`${SERVER_PORT}/programnavwfo/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    axios.get(`${SERVER_PORT}/programnavexp/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    axios.get(`${SERVER_PORT}/programnavimp/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    axios.get(`${SERVER_PORT}/programnavadm/${ReactSession.get("userrole")}`)
      .then(res => {
        console.log(res.data + "  vws ");
        setDataAdm(res.data);
        if (res.data.length === 0) {
    ...
    // Operations
    axios.get(`${SERVER_PORT}/programnavope/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    // Visitor Details
    axios.get(`${SERVER_PORT}/programnavvisi/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    axios.get(`${SERVER_PORT}/programnavlve/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    axios.get(`${SERVER_PORT}/programnavmmm/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    // Attendance
    axios.get(`${SERVER_PORT}/programnavatt/${ReactSession.get("userrole")}`)
      .then(res => {
    ...
    // Setup
    axios.get(`${SERVER_PORT}/programnavsetp/${ReactSession.get("userrole")}`)
      .then(res => {
      ...
      <aside id="sidebar-unique" className={`sidebar-unique ${isSidenavOpen ? 'open-unique' : ''}`}>
        ...
        <ul className="nav-list-unique" id="nav-list-unique">
          ...
          <li className="sidebar-item">
            ...
            <ul id="auth" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-unique">
          ...
          <li className="sidebar-item">
            ...
            <ul id="transactionMenu" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataTrn.map(pro => (
          ...
          <li className="sidebar-item">
            ...
            <ul id="viewMenu" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataVws.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
          ...
          <li className="sidebar-item">
            ...
            <ul id="exportMenu" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataExp.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
          ...
          <li className="sidebar-item">
            ...
            <ul id="importMenu" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataImp.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
          ...
          <li className="sidebar-item">
            ...
            <ul id="operationsMenu" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataOpe.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
          ...
          <li className="sidebar-item">
            ...
            <ul id="visitorMenu" className="sidebar-dropdown list-unstyled" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataVisi.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
          ...
          <li className="sidebar-item">
            ...
            <ul id="logVehicle" className="sidebar-dropdown list-unstyled" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataLVE.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
          ...
          <li className="sidebar-item">
            ...
            <ul id="materialmm" className="sidebar-dropdown list-unstyled" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataMMM.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
          ...
          <li className="sidebar-item">
            ...
            <ul id="attendanceMenu" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataAtt.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
          ...
          <li className="sidebar-item">
            ...
            <ul id="setupMenu" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataSetp.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
          ...
          <li className="sidebar-item">
            ...
            <ul id="adminMenu" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-unique">
              <li className="sidebar-item">
                {DataAdm.map(pro => (
                  <NavLink className="sidebar-link" key={pro.Program_Name} to={'/' + pro.Program_Name}>
                    {pro.Program_Nav_Name}
